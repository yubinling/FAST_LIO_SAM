...
using namespace std;
struct pointwithfeature{
  Point_T point;
  int feature;
  pointwithfeature(const Point_T& pt, int feat)
        : point(pt), feature(feat) {};
...
{
public:
  bool update_local_map(cloudblock_Ptr local_map, cloudblock_Ptr last_target_cblock,bool downornot,
